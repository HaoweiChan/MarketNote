                    ...
                    <div className="flex items-center gap-4">
                        ...
                        <div className="relative" ref={profileRef}>
                            <button 
                                ...
                                className="h-8 w-8 rounded-full bg-gradient-to-tr from-amber-500 to-purple-600 border-2 border-slate-700 cursor-pointer hover:ring-2 hover:ring-slate-600 transition ring-offset-2 ring-offset-slate-900 focus:outline-none"
                            ></button>
